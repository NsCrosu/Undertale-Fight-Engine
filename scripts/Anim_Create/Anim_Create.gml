...
/// @arg arg_0*
/// @arg arg_1*
function Anim_Create(TARGET, VAR_NAME, TWEEN, EASE, START, CHANGE, DURATION){
	var DELAY = 0;
	var ARG_0 = 0;
	var ARG_1 = 0;

	if(argument_count >= 8){DELAY = argument[7];}
	if(argument_count >= 9){ARG_0 = argument[8];}
	if(argument_count >= 10){ARG_1 = argument[9];}
